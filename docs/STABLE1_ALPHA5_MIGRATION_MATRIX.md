# Stable.1 / Alpha5-r3 / Berta2 Migration Matrix

| Area | Stable.1 base | Alpha5-r3 signal | Berta2 decision |
|---|---|---|---|
...
| MCP/UI/backend | None | Proposed future path | Explicitly excluded in Berta2 |
