...
This module does not perform network I/O. The ChatGPT/tool runtime resolves a
mutable ref (for example `stable`) using the available GitHub connector, then
passes the returned SHA here if an integration wants deterministic URLs.
"""
