# DIGR 5.0.0-Berta1 Run Workspace

`workspace/layout-v2.json` is the current layout contract. Berta1 retains the removal of overlapping legacy runtime-state/invocation state copies and persists one RunPhase lifecycle plus revisioned authoritative stores.
