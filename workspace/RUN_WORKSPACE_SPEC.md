# DIGR 5.0 Alpha 2 Run Workspace

`workspace/layout-v2.json` is the single current layout contract. Alpha 2 removes the overlapping legacy runtime-state/invocation state copies and persists one RunPhase lifecycle plus revisioned authoritative stores.
